...
export const popularCategorySearches = [
  ...
  { id: 'documents-procedures', label: { en: 'Documents & Procedures' }, query: 'Documents' },
...
export const serviceCategories: ServiceCategory[] = [
  ...
  category(
    ...
    [
      sub('Documents & Procedures', '📑', 'Contracts & forms', 'contracts-forms', 'Lease, renovation, vehicle, employment form skeletons.'),
      sub('Documents & Procedures', '🪪', 'Licenses & permits', 'licenses-permits', 'Activity licenses and permits — verify per region.'),
      sub('Documents & Procedures', '🏢', 'Start a business', 'start-business', 'Business registration checklists by country.'),
      sub('Documents & Procedures', '🏠', 'Real estate', 'docs-real-estate', 'Property purchase and related procedures.'),
      sub('Documents & Procedures', '🚗', 'Vehicles', 'vehicles', 'Vehicle purchase, rental, and registration pointers.'),
      sub('Documents & Procedures', '🔨', 'Construction & repair', 'construction-repair', 'Construction and renovation contracts and acts.'),
      sub('Documents & Procedures', '💼', 'Work & professions', 'work-professions', 'Employment and professional documents.'),
      sub('Documents & Procedures', '⚖️', 'Legal matters', 'legal-matters', 'Legal procedure entry points.'),
      sub('Documents & Procedures', '💰', 'Taxes & finance', 'taxes-finance', 'Tax authority portals and procedures.'),
      sub('Documents & Procedures', '🌍', 'Migration & residence', 'migration-residence', 'Residence and immigration official sources.'),
      sub('Documents & Procedures', '📋', 'Government procedures', 'government-procedures', 'National and municipal procedures.'),
      sub('Documents & Procedures', '🏦', 'Banks & financial services', 'banks-finance', 'Banking-related official information.'),
      sub('Documents & Procedures', '👨‍👩‍👧', 'Personal documents', 'personal-documents', 'Personal civil documents — official sources only.'),
    ],
  ),
