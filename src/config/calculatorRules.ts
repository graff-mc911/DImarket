    ...
    new: [
      {
        ...
        notes: 'May be included in dealer quote or itemized separately. Spain engine omits when quote is turnkey-net of registration costs.',
      },
      {
        id: 'es-car-new-iedmt',
      ...
      {
        id: 'es-car-new-plates-docs',
        name: 'Plates & Documentation',
        type: 'fee',
        isMandatory: true,
