  ...
  return (
    <div className="glass-card p-4">
      <div className="mb-3 flex items-start gap-3">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-none border border-[var(--glass-border)] bg-[rgba(255,248,241,0.34)] text-[var(--accent-700)]">
          {icon}
        </div>
