    ...
    <section className="mt-4 border-t border-[rgba(148,163,184,0.18)] pt-3">
      ...
      <div className="mb-3 grid grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-5">
        {statCards.map((card) => (
          <div
            key={card.label}
            className="rounded-none border border-white/38 bg-[rgba(255,255,255,0.30)] p-2.5 shadow-[0_6px_18px_rgba(15,23,42,0.04)] backdrop-blur-xl"
          >
          ...
          <div className="space-y-1.5">
            {stats.country_ranking.map((item, index) => (
              <div
                ...
                className="flex flex-col gap-1.5 rounded-none border border-[rgba(148,163,184,0.14)] bg-[rgba(248,250,252,0.54)] p-2 lg:flex-row lg:items-center lg:justify-between"
              >
