      ...
      <div className="cabinet-sheet">
        <div className="cabinet-sheet__head">
          <div className="dimarket-categories__head mb-0" style={{ textAlign: 'center' }}>
            <p className="dimarket-categories__eyebrow">{t('homePremium.faqEyebrow')}</p>
            <h2 id="home-faq-title" className="dimarket-categories__title">
              {t('homePremium.faqTitle')}
            </h2>
            <p className="home-section__subtitle" style={{ marginTop: '0.35rem' }}>
              {t('homePremium.faqSubtitle')}
            </p>
          </div>
        </div>

        <div className="home-faq home-faq--sheet">
          {items.map((item) => {
