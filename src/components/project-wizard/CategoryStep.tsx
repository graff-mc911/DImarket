            ...
            <button
              ...
              className={
                ...
                (active
                  ...
                  : 'border-[rgba(148,163,184,0.22)] bg-[#fafafa] text-[color:var(--ink-900)] hover:border-[rgba(148,163,184,0.35)] hover:bg-white hover:shadow-sm')
              }
            >
              <span
                className={
              ...
              >
                <Icon className={'h-6 w-6 ' + (active ? 'text-white' : 'text-[color:var(--ink-900)]')} />
              </span>
