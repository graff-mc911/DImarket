...
export function CategoryCircleTile({
  ...
  return (
    ...
    >
      <span className="flex h-20 w-full items-center justify-center rounded-md border border-[#d5d9d9] bg-[#f7fafa] text-[var(--accent-600)] transition group-hover:border-[#ff9900] group-hover:bg-white sm:h-24">
