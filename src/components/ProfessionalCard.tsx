...
export function ProfessionalCard({
  ...
  const avatarFallbackClass = compact
    ? 'pro-card__avatar flex shrink-0 items-center justify-center rounded-none border border-[var(--glass-border)] bg-[rgba(255,248,241,0.42)] font-bold text-[var(--accent-700)]'
