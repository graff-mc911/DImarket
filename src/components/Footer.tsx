...
export function Footer() {
  ...
  return (
    <footer className="mt-auto w-full px-4 pb-3 md:px-6 xl:px-8 2xl:px-10">
      <div className="w-full rounded-[22px] border border-white/70 bg-[rgba(252,246,240,0.96)] p-3 shadow-[0_12px_32px_rgba(89,63,48,0.06)] md:bg-[#faf6f0] md:backdrop-blur-none md:p-4">
