const enUiText = {
  ...
  'home.heroSimpleTitle':
    'Find a master for repair, installation, or building work.',
  ...
  'home.noProfessionals': 'No professionals available yet.',
...
const ukUiText: Record<string, string> = {
  // Header
...
const uiTranslations: Record<string, Record<string, string>> = {
  en: enUiText,
  uk: { ...enUiText, ...ukUiText },
}

export function getUiText(languageCode: string, key: string): string {
  const languageText = uiTranslations[languageCode] || uiTranslations.en
  return languageText[key] || uiTranslations.en[key] || key
}
