...
export const enTranslations = {
  ...
  'marketplace.noCompanies': 'No companies matched this category yet.',
  ...
  'marketplace.categoryStats': 'Category statistics',
  'marketplace.categoryFilters': 'Category filters',
  'marketplace.filterAll': 'All',
  'marketplace.filterInterior': 'Interior',
  'marketplace.filterExterior': 'Exterior',
  'marketplace.filterEngineering': 'Engineering',
  'marketplace.filterEmergency': 'Emergency',
  'marketplace.filterRenovation': 'Renovation',
  'marketplace.trendingCategories': 'Trending Categories',
  ...
  'catPage.aiRecommendationText':
    'Recommended professionals are ranked for {location} using your previous searches ({signals}), verification, rating, and availability signals.',
  'catPage.yourArea': 'your area',
  'catPage.priceGuide': 'Price guide',
  'catPage.priceGuideSubtitle': 'Estimated {category} budgets from recent projects and market benchmarks.',
  'catPage.estimatedPriceRange': 'Estimated price range',
  'catPage.perProject': 'per project',
  'catPage.averageDuration': 'Average project duration',
  'catPage.days': 'days',
  'catPage.durationHint': 'Typical planning-to-completion window',
  'catPage.quoteAccuracy': 'Quote accuracy',
  'catPage.quoteAccuracyValue': 'Custom quote recommended',
  'catPage.beforeAfterGallery': 'Before / After gallery',
  'catPage.beforeAfterSubtitle': 'Recent portfolio and project photos from professionals in this category.',
  'catPage.before': 'Before',
  'catPage.after': 'After',
  'catPage.projectPhoto': 'Project photo',
  'catPage.customerReviews': 'Customer reviews',
  'catPage.reviewCarouselControls': 'Review carousel controls',
  'catPage.previousReview': 'Previous review',
  'catPage.nextReview': 'Next review',
  'catPage.reviewsStat': 'Reviews',
  'catPage.responseSameDay': 'Same day',
