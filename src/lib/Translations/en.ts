...
export const enTranslations = {
  ...
  'register.alreadyRegistered': 'This email is already registered. Sign in or reset your password.',
  ...
  'settings.error.deleteAccountNotDeployed':
    'The delete-account function is missing in this Supabase project. Deploy it to the same project as VITE_SUPABASE_URL, or update .env to match the project where the function exists.',
