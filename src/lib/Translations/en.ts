...
export const enTranslations = {
  ...
  'mapExplore.subtitle': 'Professionals, companies, and active projects on one interactive map — filtered by your location.',
  ...
  'mapExplore.empty': 'No professionals, companies or projects found in this area.',
  'mapExplore.expandRadius': 'Expand search radius',
  'mapExplore.resultsCount': '{count} results on the map',
