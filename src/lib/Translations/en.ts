...
export const enTranslations = {
  ...
  'advertising.mediaEditor.previewFrame': 'Banner frame',
  'advertising.mediaEditor.dragHint': 'Drag on the preview to reposition. Cropping matches the site.',
  'advertising.mediaEditor.fit': 'Fit',
  'advertising.mediaEditor.fitCover': 'Fill (may crop)',
  'advertising.mediaEditor.fitContain': 'Fit entire image',
  'advertising.mediaEditor.scale': 'Scale',
  'advertising.mediaEditor.brightness': 'Brightness',
  'advertising.mediaEditor.contrast': 'Contrast',
  'advertising.mediaEditor.positionX': 'Position ↔',
  'advertising.mediaEditor.positionY': 'Position ↕',
  'advertising.mediaEditor.slideshow': 'Multiple images (animation)',
  'advertising.mediaEditor.slideshowHint': 'Add 2–6 images — they will rotate on the banner.',
  ...
  'advertising.mediaEditor.bannerTypesHint': 'Separate framing for side, center, leaderboard, and mobile banners.',
  'advertising.mediaEditor.resetLayout': 'Reset to default',
  'advertising.mediaEditor.transition': 'Transition',
  'advertising.mediaEditor.slideshowNeedTwo': 'Add another image to enable animation.',
