...
export const enTranslations = {
  ...
  'verification.businessDetails': 'Business & address',
  'verification.documents': 'Documents',
  'verification.documentsHint':
    'Upload identity, address, business registration, and professional license. Files are stored privately in Supabase.',
  ...
  'verification.docAddress': 'Proof of address',
  ...
  'verification.recentHistory': 'Recent review history',
  'verification.checksTitle': 'Verification levels',
  'verification.checksHint':
    'Email · Phone · Identity · Business registration · Professional license · Address',
  ...
  'verification.status.needs_info': 'Needs documents',
