...
export const enTranslations = {
  ...
  'companiesDir.seoTitle': 'Companies Directory | DImarket',
  'companiesDir.seoDescription':
    'Discover construction companies, suppliers, manufacturers and stores across Europe on DImarket.',
  'companiesDir.heroTitle': 'Find trusted construction companies',
  'companiesDir.heroSubtitle':
    'Browse verified firms, material stores and specialist suppliers — compare ratings, services and locations.',
  'companiesDir.search': 'Search',
  'companiesDir.searchPlaceholder': 'Company, service, category, city or country…',
  'companiesDir.popularCategories': 'Popular categories',
  'companiesDir.featured': 'Featured companies',
  'companiesDir.latest': 'Latest companies',
  'companiesDir.directory': 'Companies directory',
  'companiesDir.countSuffix': 'companies',
  'companiesDir.filters': 'Filters',
  'companiesDir.viewToggle': 'View mode',
  'companiesDir.gridView': 'Grid',
  'companiesDir.mapView': 'Map',
  'companiesDir.resetFilters': 'Reset filters',
  'companiesDir.empty': 'No companies match your filters.',
  'companiesDir.prev': 'Previous',
  'companiesDir.next': 'Next',
  'companiesDir.page': 'Page {page}',
  'companiesDir.listYourCompany': 'List your company on DImarket',
  'companiesDir.viewCompany': 'View company',
  'companiesDir.verified': 'Verified',
  'companiesDir.premium': 'Premium',
  'companiesDir.openNow': 'Open now',
  'companiesDir.reviews': 'reviews',
  'companiesDir.projects': 'projects',
  'companiesDir.founded': 'Founded',
  'companiesDir.noDescription': 'No description yet.',
  'companiesDir.category': 'Category',
  'companiesDir.allCategories': 'All categories',
  'companiesDir.minRating': 'Minimum rating',
  'companiesDir.anyRating': 'Any rating',
  'companiesDir.country': 'Country',
  'companiesDir.allCountries': 'All countries',
  'companiesDir.city': 'City',
  'companiesDir.allCities': 'All cities',
  'companiesDir.languages': 'Languages',
  'companiesDir.anyLanguage': 'Any language',
  'companiesDir.sort': 'Sort by',
  'companiesDir.sortRated': 'Highest rated',
  'companiesDir.sortNewest': 'Newest',
  'companiesDir.sortProjects': 'Most projects',
  'companiesDir.sortAlpha': 'Alphabetically',
  'companiesDir.mapEmpty': 'No companies with map coordinates for these filters.',
  'companiesDir.hoursUnavailable': 'Hours not listed',
  'companiesDir.day.mon': 'Mon',
  'companiesDir.day.tue': 'Tue',
  'companiesDir.day.wed': 'Wed',
  'companiesDir.day.thu': 'Thu',
  'companiesDir.day.fri': 'Fri',
  'companiesDir.day.sat': 'Sat',
  'companiesDir.day.sun': 'Sun',
  'companiesDir.notFound': 'Company not found',
  'companiesDir.backToDirectory': 'Back to directory',
  'companiesDir.profileSeo': '{name} — company profile on DImarket',
  'companiesDir.about': 'About company',
  'companiesDir.services': 'Services',
  'companiesDir.portfolio': 'Portfolio & projects',
  'companiesDir.gallery': 'Gallery',
  'companiesDir.team': 'Team',
  'companiesDir.certificates': 'Certificates',
  'companiesDir.licenses': 'Licenses',
  'companiesDir.brands': 'Brands',
  'companiesDir.reviewsSection': 'Reviews',
  'companiesDir.contact': 'Contact',
  'companiesDir.workingHours': 'Working hours',
  'companiesDir.map': 'Map',
  'companiesDir.social': 'Social media',
  'companiesDir.call': 'Call',
  'companiesDir.website': 'Website',
  'companiesDir.sections': 'Profile sections',
  'companiesDir.noReviews': 'No reviews yet.',
  'companiesDir.cat.construction': 'Construction Companies',
  'companiesDir.cat.renovation': 'Renovation Companies',
  'companiesDir.cat.architects': 'Architects',
  'companiesDir.cat.engineering': 'Engineering',
  'companiesDir.cat.interior': 'Interior Design',
  'companiesDir.cat.materials': 'Building Material Stores',
  'companiesDir.cat.electrical': 'Electrical Stores',
  'companiesDir.cat.plumbing': 'Plumbing Stores',
  'companiesDir.cat.tools': 'Tool Stores',
  'companiesDir.cat.roofing': 'Roofing Suppliers',
  'companiesDir.cat.hvac': 'HVAC Suppliers',
  'companiesDir.cat.solar': 'Solar Companies',
  'companiesDir.cat.windows': 'Window & Door Companies',
  'companiesDir.cat.furniture': 'Furniture Companies',
  'companiesDir.cat.landscape': 'Landscape Companies',
  'companiesDir.cat.pools': 'Pool Companies',
  'companiesDir.cat.smartHome': 'Smart Home Companies',
