...
export const enTranslations = {
  ...
  'proProfile.notFound': 'Professional profile not found',
  'proProfile.backToCatalog': 'Back to professionals',
  'proProfile.professionals': 'Professionals',
  'proProfile.professional': 'Professional',
  'proProfile.verified': 'Verified',
  'proProfile.premium': 'Premium',
  'proProfile.yearsExp': '{n}+ years experience',
  'proProfile.memberSince': 'Member since',
  'proProfile.responseUnknown': 'Response time n/a',
  'proProfile.responseUnder1h': 'Responds in under 1 hour',
  'proProfile.responseHours': 'Responds in ~{h}h',
  'proProfile.responseDays': 'Responds in ~{d}d',
  'proProfile.availAvailable': 'Available now',
  'proProfile.availBusy': 'Busy',
  'proProfile.availLimited': 'Limited availability',
  'proProfile.availUnavailable': 'Unavailable',
  'proProfile.requestQuote': 'Request quote',
  'proProfile.chat': 'Chat',
  'proProfile.call': 'Call',
  'proProfile.save': 'Save',
  'proProfile.saved': 'Saved',
  'proProfile.share': 'Share',
  'proProfile.report': 'Report',
  'proProfile.linkCopied': 'Profile link copied',
  'proProfile.reportReason': 'Reason for report',
  'proProfile.reportPlaceholder': 'Describe the issue…',
  'proProfile.submitReport': 'Submit report',
  'proProfile.reportThanks': 'Thanks — we received your report.',
  'proProfile.reportError': 'Could not send report. Try again later.',
  'proProfile.sections': 'Profile sections',
  'proProfile.trust': 'Trust & stats',
  'proProfile.overallRating': 'Overall rating',
  'proProfile.reviewsCount': 'Reviews',
  'proProfile.completedProjects': 'Completed projects',
  'proProfile.repeatCustomers': 'Repeat customers',
  'proProfile.recommendationRate': 'Recommendation rate',
  'proProfile.profileViews': 'Profile views',
  'proProfile.about': 'About',
  'proProfile.noBio': 'Biography not added yet.',
  'proProfile.specializations': 'Specializations',
  'proProfile.certificates': 'Certificates',
  'proProfile.licenses': 'Licenses',
  'proProfile.insurance': 'Insurance',
  'proProfile.warranty': 'Warranty',
  'proProfile.services': 'Services',
  'proProfile.noServices': 'No services listed yet.',
  'proProfile.portfolio': 'Portfolio',
  'proProfile.projectHistory': 'Project history',
  'proProfile.noProjects': 'No completed projects listed yet.',
  'proProfile.durationDays': '{n} days',
  'proProfile.reviews': 'Reviews',
  'proProfile.workingArea': 'Working area',
  'proProfile.noMap': 'Map location not set.',
  'proProfile.travelRadius': 'Travel radius: {n} km',
  'proProfile.countries': 'Countries',
  'proProfile.cities': 'Cities',
  'proProfile.workingHours': 'Working hours',
  'proProfile.hoursUnavailable': 'Hours not listed',
  'proProfile.closed': 'Closed',
  'proProfile.day.mon': 'Monday',
  'proProfile.day.tue': 'Tuesday',
  'proProfile.day.wed': 'Wednesday',
  'proProfile.day.thu': 'Thursday',
  'proProfile.day.fri': 'Friday',
  'proProfile.day.sat': 'Saturday',
  'proProfile.day.sun': 'Sunday',
  'proProfile.emergency': 'Emergency available',
  'proProfile.weekend': 'Weekend available',
  'proProfile.contact': 'Contact',
  'proProfile.social': 'Social',
  'proProfile.similar': 'Similar professionals',
  'proProfile.seoDescription':
    '{name} — verified professional on DImarket. Hire in {city}.',
