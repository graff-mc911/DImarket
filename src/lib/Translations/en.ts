...
export const enTranslations = {
  ...
  'project.matches.sub':
    'AI ranked Top 10 by category, location, budget, timeline, languages, rating, completed jobs, response time & availability',
  'project.matches.viewProject': 'View project',
  'project.matches.myProjects': 'My projects',
  'project.matches.empty': 'No matches yet. Professionals will receive a New AI Match notification.',
  'project.matches.bestValue': 'Best value',
  'project.matches.fastest': 'Fastest response',
  'project.matches.highestRating': 'Highest rating',
  'project.matches.closest': 'Closest location',
  'project.matches.why': 'Why recommended',
  'project.matches.invite': 'Invite',
  'project.matches.compare': 'Compare',
  'project.matches.save': 'Save',
  'common.back': 'Back',
