...
export const enTranslations = {
  ...
  'verification.menu': 'Trust & Verification',
  'verification.title': 'Trust & Verification',
  'verification.subtitle': 'Verify your identity and build customer trust',
  'verification.businessName': 'Business name',
  'verification.vat': 'VAT / tax ID',
  'verification.addressLine': 'Street address',
  'verification.addressCity': 'City',
  'verification.addressPostal': 'Postal code',
  'verification.addressCountry': 'Country',
  'verification.yearsExperience': 'Years of experience',
  'verification.businessDetails': 'Details & address',
  'verification.documents': 'Documents',
  'verification.documentsHint':
    'PDF, JPG, PNG, HEIC. Stored privately in Supabase with signed downloads.',
  ...
  'verification.resubmit': 'Resubmit for review',
  ...
  'verification.uploadedShort': 'Uploaded',
  ...
  'verification.requestInfo': 'Request documents',
  'verification.requestInfoNotesRequired': 'Add notes describing which documents are needed.',
  'verification.reviewNotes': 'Reviewer notes',
  'verification.reviewNotesPlaceholder': 'Reason for reject / documents to request…',
  'verification.adminTitle': 'Verification review',
  'verification.adminEmpty': 'No verifications in this queue',
  'verification.history': 'Verification history',
  'verification.timeline': 'Verification timeline',
  'verification.certificates': 'Certificates & licenses',
  'verification.secureDownload': 'Secure download',
  'verification.progress': 'Verification progress',
  'verification.trustScore': 'Trust Score',
  'verification.trustScoreHint':
    'Based on verification, reviews, projects, response time, profile completeness, and tenure.',
  'verification.aiTips': 'AI recommendations to increase Trust Score',
  'verification.checksTitle': 'Verification types',
  'verification.completedSteps': 'Completed',
  'verification.missingSteps': 'Missing',
  'verification.allComplete': 'All steps complete',
  'verification.roleCustomer': 'Customers: Email · Phone · Identity · Address',
  'verification.roleCompany':
    'Companies: Business registration · VAT · Address · Insurance · Licenses',
  'verification.roleProfessional':
    'Professionals: Identity · License · Insurance · Experience',
  'verification.confirm': 'Confirm',
  'verification.emailMarked': 'Email verified',
  'verification.phoneMarked': 'Phone verified',
  'verification.addPhoneFirst': 'Add a phone number in Settings first',
  'verification.needsInfoTitle': 'Additional documents requested',
  'verification.rejectedTitle': 'Verification rejected',
  'verification.gdprHint':
    'Documents are private. Access is logged for GDPR compliance. You can request deletion via support.',
  'verification.status.unverified': 'Unverified',
  'verification.status.pending': 'Pending',
  'verification.status.verified': 'Verified',
  'verification.status.rejected': 'Rejected',
  'verification.status.needs_info': 'Need more information',
  'advancedSearch.businessVerifiedOnly': 'Business Verified',
