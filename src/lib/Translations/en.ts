...
export const enTranslations = {
  ...
  'costEstimator.disclaimer': 'Орієнтовна оцінка — not a contractor quote. Compare real offers from DImarket professionals.',
  'costEstimator.type.renovation': 'Renovation',
  ...
  'costEstimator.type.landscaping': 'Landscaping',
