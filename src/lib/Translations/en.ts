...
export const enTranslations = {
  ...
  'reviews.emptyContent': 'Add a comment or photo',
  'reviews.onlyCompleted': 'Only customers with a completed project can leave a review.',
  'reviews.selectProject': 'Completed project',
  'reviews.beforePhotos': 'Before photos (optional)',
  'reviews.afterPhotos': 'After photos (optional)',
  'reviews.extraMedia': 'More photos & videos (optional)',
  'reviews.addMedia': 'Add media',
  'reviews.uploading': 'Uploading…',
  'reviews.mediaOptionalHint': 'Optional · up to {max} files',
  'reviews.verifiedProject': 'Verified project',
  'reviews.completedOn': 'Completed',
  'reviews.recommends': 'Recommends this professional',
  'reviews.before': 'Before',
  'reviews.after': 'After',
  'reviews.helpful': 'Helpful',
  'reviews.notHelpful': 'Not helpful',
  'reviews.reply': 'Reply',
  'reviews.proReply': 'Professional reply',
  'reviews.proBadge': 'Pro',
  'reviews.replyPlaceholder': 'Write a reply…',
  'reviews.proReplyPlaceholder': 'Reply as the professional…',
  'reviews.send': 'Send',
  ...
  'reviews.verifiedOnly': 'Verified reviews only',
  'reviews.loading': 'Loading reviews…',
  'reviews.countLabel': '{count} reviews',
  'reviews.empty': 'No reviews yet.',
  'reviews.thanks': 'Thanks! Your review was saved.',
  'reviews.averageScore': 'Average score',
  'reviews.beFirst': 'Be the first to leave feedback.',
  'reviews.recommendPct': '{pct}% recommend',
