...
const LOCATION_AWARE_PATH =
  /^\/(search|map|professionals|companies|listings|services|electrician|plumber|painter|tiler|carpenter|roofer|handyman|lawyer|accountant|architect|hvac|cleaning|moving|renovation)(\/|$)/i
