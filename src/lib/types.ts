...
// ============================================================
// РОЛІ КОРИСТУВАЧІВ
// client      — замовник, шукає фахівця або послугу
// professional — фахівець або фізична особа що надає послуги
...
export interface Database {
  public: {
    Tables: {
      ...
      // Включає клієнтів, фахівців, компанії та власника
      // ----------------------------------------------------------
      profiles: {
        Row: {
          id: string
      ...
      // ----------------------------------------------------------
      // listings — оголошення
      // Типи: пошук фахівця, пропозиція послуг, продаж, пошук товару
      // ----------------------------------------------------------
      listings: {
        Row: {
          id: string
      ...
      // ----------------------------------------------------------
      // portfolio_items — портфоліо фахівця або компанії
      // ----------------------------------------------------------
      portfolio_items: {
        Row: {
          id: string
      ...
      // ----------------------------------------------------------
      // reviews — відгуки
      // Двосторонні: клієнт → фахівець і фахівець → клієнт
      ...
      // ----------------------------------------------------------
      // professional_categories — категорії фахівця/компанії
      // ----------------------------------------------------------
...
// Профіль з портфоліо — для сторінки фахівця
