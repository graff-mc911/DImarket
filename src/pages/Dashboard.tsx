...
export function Dashboard() {
  ...
  useEffect(() => {
    // Reload only when the signed-in user id changes — not on TOKEN_REFRESHED
    // (new `user` object identity), which remounted OwnerAdManager, wiped
    // the open «Нова реклама» form, and dumped scroll toward the footer.
