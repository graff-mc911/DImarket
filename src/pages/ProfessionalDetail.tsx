...
export function ProfessionalDetail({ profileId }: ProfessionalDetailProps) {
  ...
  const initials = profile?.full_name
    ...
    : 'DI'
  const avatarPhoto = profile ? resolveProfileAvatarUrl(profile) : null
      ...
      <div className="lg:grid lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start lg:gap-6">
        ...
        <aside className="amazon-buy-box amazon-buy-box--sticky mt-4 lg:mt-0">
          ...
          {isFeatured && !isPremium && (
            <div className="mb-3 flex items-center gap-1 rounded-sm bg-[#ff9900] px-2 py-1 text-xs font-bold text-[color:var(--ink-900)]">
